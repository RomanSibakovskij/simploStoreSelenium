...
public class CheckoutPageTooLongSingularInputTest extends TestMethods{
    ...
    //Test 022ai -> invalid single product ("Polštář Furniture") checkout confirmation test - too long billing zip code (6 digits) (the too long zip code error wasn't triggered)
    @Test
    @DisplayName("Invalid Single Product Checkout Confirmation Test (as a guest) - Too Long Billing Zip Code")
    @Tag("Invalid_Single_Product_Checkout_Confirmation")
    @Tag("Too_Long_Singular_Input")
    @Tag("Test_As_A_Guest")
    void invalidSingleProductCheckoutGuestTooLongZipCodeTest() {
        //add single chosen product ("Polštář Furniture") to cart test - as a guest
        addSingleChosenProductToCartTest();
        //add single chosen product ("Polštář Furniture") to check out test - as a guest
        addProductToCheckoutTest();
        //invalid single product ("Polštář Furniture") checkout confirmation test - too long billing zip code (6 digits)
    ...
    //Test 022ak -> invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping first name (51 chars)
    @Test
    @DisplayName("Invalid Single Product Checkout Confirmation Test (as a guest) - Too Long Shipping First Name")
    @Tag("Invalid_Single_Product_Checkout_Confirmation")
    @Tag("Too_Long_Singular_Input")
    @Tag("Test_As_A_Guest")
    void invalidSingleProductCheckoutGuestTooLongShipFirstNameTest() {
        //add single chosen product ("Polštář Furniture") to cart test - as a guest
        addSingleChosenProductToCartTest();
        //add single chosen product ("Polštář Furniture") to check out test - as a guest
        addProductToCheckoutTest();
        //invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping first name (51 chars)
        invalidProductCheckoutConfirmationGuestTooLongShipFirstNameTest();
    }

    //Test 022al -> invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping last name (51 chars)
    @Test
    @DisplayName("Invalid Single Product Checkout Confirmation Test (as a guest) - Too Long Shipping Last Name")
    @Tag("Invalid_Single_Product_Checkout_Confirmation")
    @Tag("Too_Long_Singular_Input")
    @Tag("Test_As_A_Guest")
    void invalidSingleProductCheckoutGuestTooLongShipLastNameTest() {
        //add single chosen product ("Polštář Furniture") to cart test - as a guest
        addSingleChosenProductToCartTest();
        //add single chosen product ("Polštář Furniture") to check out test - as a guest
        addProductToCheckoutTest();
        //invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping last name (51 chars)
        invalidProductCheckoutConfirmationGuestTooLongShipLastNameTest();
    }

    //Test 022am -> invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping street (101 chars)
    @Test
    @DisplayName("Invalid Single Product Checkout Confirmation Test (as a guest) - Too Long Shipping Street")
    @Tag("Invalid_Single_Product_Checkout_Confirmation")
    @Tag("Too_Long_Singular_Input")
    @Tag("Test_As_A_Guest")
    void invalidSingleProductCheckoutGuestTooLongShipStreetTest() {
        //add single chosen product ("Polštář Furniture") to cart test - as a guest
        addSingleChosenProductToCartTest();
        //add single chosen product ("Polštář Furniture") to check out test - as a guest
        addProductToCheckoutTest();
        //invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping street (101 chars)
        invalidProductCheckoutConfirmationGuestTooLongShipStreetTest();
    }

    //Test 022an -> invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping city (51 chars)
    @Test
    @DisplayName("Invalid Single Product Checkout Confirmation Test (as a guest) - Too Long Shipping City")
    @Tag("Invalid_Single_Product_Checkout_Confirmation")
    @Tag("Too_Long_Singular_Input")
    @Tag("Test_As_A_Guest")
    void invalidSingleProductCheckoutGuestTooLongShipCityTest() {
        //add single chosen product ("Polštář Furniture") to cart test - as a guest
        addSingleChosenProductToCartTest();
        //add single chosen product ("Polštář Furniture") to check out test - as a guest
        addProductToCheckoutTest();
        //invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping city (51 chars)
        invalidProductCheckoutConfirmationGuestTooLongShipCityTest();
    }

    //Test 022ao -> invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping zip code (6 digits)
    @Test
    @DisplayName("Invalid Single Product Checkout Confirmation Test (as a guest) - Too Long Shipping Zip Code")
    @Tag("Invalid_Single_Product_Checkout_Confirmation")
    @Tag("Too_Long_Singular_Input")
    @Tag("Test_As_A_Guest")
    void invalidSingleProductCheckoutGuestTooLongShipZipCodeTest() {
        //add single chosen product ("Polštář Furniture") to cart test - as a guest
        addSingleChosenProductToCartTest();
        //add single chosen product ("Polštář Furniture") to check out test - as a guest
        addProductToCheckoutTest();
        //invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping zip code (6 digits)
        invalidProductCheckoutConfirmationGuestTooLongShipZipCodeTest();
    }

    //Test 022ap -> invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping phone (30 digits)
    @Test
    @DisplayName("Invalid Single Product Checkout Confirmation Test (as a guest) - Too Long Shipping Phone")
    @Tag("Invalid_Single_Product_Checkout_Confirmation")
    @Tag("Too_Long_Singular_Input")
    @Tag("Test_As_A_Guest")
    void invalidSingleProductCheckoutGuestTooLongShipPhoneTest() {
        //add single chosen product ("Polštář Furniture") to cart test - as a guest
        addSingleChosenProductToCartTest();
        //add single chosen product ("Polštář Furniture") to check out test - as a guest
        addProductToCheckoutTest();
        //invalid single product ("Polštář Furniture") checkout confirmation test - too long shipping phone (30 digits)
        invalidProductCheckoutConfirmationGuestTooLongShipPhoneTest();
    }
