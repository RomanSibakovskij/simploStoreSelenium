...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //invalid product checkout confirmation test method - too long shipping first name (100 char)
    protected void invalidProductCheckoutConfirmationGuestTooLongShipFirstNameTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageTooLongSingularInput checkoutPageTooLongSingularInput = new CheckoutPageTooLongSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - too long shipping first name (100 chars)
        checkoutPageTooLongSingularInput.invalidCheckoutShipAddressInputDataTooLongFirstNameGetter();
        //input too long first name into first name input field (100 chars)
        checkoutPageTooLongSingularInput.inputTooLongCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        //input valid street into street input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipStreetIntoShipStreetInputField();
        //input valid city into city input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipCityIntoShipCityInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryDropdownMenu();
        //select "United States" option
        checkoutPage.selectSetShipCountryOption(3);
        //input valid zip code into zip code input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipZipCodeIntoShipZipCodeInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryCodeDropdownMenu();
        //capture screenshot of the checkout page billing section absence of country codes
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display Country Code Options Absence");
        //input valid phone into phone input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - too long shipping first name
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Too Long Shipping First Name");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže být delší než 50 znaků.", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping first name input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping First Name - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping First Name");
    }

    //invalid product checkout confirmation test method - too long shipping last name (51 chars)
    protected void invalidProductCheckoutConfirmationGuestTooLongShipLastNameTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageTooLongSingularInput checkoutPageTooLongSingularInput = new CheckoutPageTooLongSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - too long shipping last name (100 chars)
        checkoutPageTooLongSingularInput.invalidCheckoutShipAddressInputDataTooLongLastNameGetter();
        //input valid first name into first name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input too long last name into last name input field (100 chars)
        checkoutPageTooLongSingularInput.inputTooLongCheckoutShipLastNameIntoShipLastNameInputField();
        //input valid street into street input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipStreetIntoShipStreetInputField();
        //input valid city into city input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipCityIntoShipCityInputField();
        ...
        //input valid phone into phone input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - too long shipping last name
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Too Long Shipping Last Name");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže být delší než 50 znaků.", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping last name input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Last Name - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Last Name");
    }

    //invalid product checkout confirmation test method - too long shipping street (101 chars)
    protected void invalidProductCheckoutConfirmationGuestTooLongShipStreetTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageTooLongSingularInput checkoutPageTooLongSingularInput = new CheckoutPageTooLongSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - too long shipping street (101 chars)
        checkoutPageTooLongSingularInput.invalidCheckoutShipAddressInputDataTooLongStreetGetter();
        //input valid first name into first name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        //input too short street into street input field (101 chars)
        checkoutPageTooLongSingularInput.inputTooLongCheckoutShipStreetIntoShipStreetInputField();
        //input valid city into city input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipCityIntoShipCityInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryDropdownMenu();
        ...
        //input valid phone into phone input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - too long shipping street
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Too Long Shipping Street");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže být delší než 100 znaků.", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping street input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Street - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Street");
    }

    //invalid product checkout confirmation test method - too long shipping city (51 chars)
    protected void invalidProductCheckoutConfirmationGuestTooLongShipCityTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageTooLongSingularInput checkoutPageTooLongSingularInput = new CheckoutPageTooLongSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - too long shipping city (51 chars)
        checkoutPageTooLongSingularInput.invalidCheckoutShipAddressInputDataTooLongCityGetter();
        //input valid first name into first name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        //input valid street into street input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipStreetIntoShipStreetInputField();
        //input too long city into city input field (51 chars)
        checkoutPageTooLongSingularInput.inputTooLongCheckoutShipCityIntoShipCityInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryDropdownMenu();
        //select "United States" option
        checkoutPage.selectSetShipCountryOption(3);
        ...
        //input valid phone into phone input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - too long shipping city
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Too Long Shipping City");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže být delší než 50 znaků.", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping city input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping City - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping City");
    }

    //invalid product checkout confirmation test method - too long shipping zip code (6 digits)
    protected void invalidProductCheckoutConfirmationGuestTooLongShipZipCodeTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageTooLongSingularInput checkoutPageTooLongSingularInput = new CheckoutPageTooLongSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - too long shipping zip code (6 digits)
        checkoutPageTooLongSingularInput.invalidCheckoutShipAddressInputDataTooLongZipCodeGetter();
        //input valid first name into first name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        ...
        checkoutPage.selectSetShipCountryOption(3);
        //input too long zip code into zip code input field (6 digits)
        checkoutPageTooLongSingularInput.inputTooLongCheckoutShipZipCodeIntoShipZipCodeInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryCodeDropdownMenu();
        //capture screenshot of the checkout page billing section absence of country codes
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display Country Code Options Absence");
        //input valid phone into phone input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - too long shipping zip code
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Too Long Shipping Zip Code");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole obsahuje příliš dlouhý vstup", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping zip code input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Zip Code - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Zip Code");
    }

    //invalid product checkout confirmation test method - too long shipping phone (30 digits)
    protected void invalidProductCheckoutConfirmationGuestTooLongShipPhoneTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageTooLongSingularInput checkoutPageTooLongSingularInput = new CheckoutPageTooLongSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - too long shipping phone (30 digits)
        checkoutPageTooLongSingularInput.invalidCheckoutShipAddressInputDataTooLongPhoneGetter();
        //input valid first name into first name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageTooLongSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        ...
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display Country Code Options Absence");
        //input too long phone into phone input field (30 digits)
        checkoutPageTooLongSingularInput.inputTooLongCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - too short shipping phone (30 digits)
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Too Long Shipping Phone");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole musí být platné telefonní číslo.", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping phone error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Phone - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Too Long Shipping Phone");
    }

    //invalid singular input format

    //invalid product checkout confirmation test method - invalid email format (missing '@')
    protected void invalidProductCheckoutConfirmationGuestInvalidEmailFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        ...
        //capture screenshot of the checkout page billing section display before address data input
        captureScreenshot(driver, "Checkout Page Billing Address Section Display Before Address Data Input (guest)");
        //invalid checkout billing address email input data getter - invalid email format (missing '@')
        checkoutPageInvalidSingularInput.invalidCheckoutBillAddressInvalidEmailFormatInputDataGetter();
        //=input invalid email format into email input field (missing '@')
        checkoutPageInvalidSingularInput.inputInvalidCheckoutEmailFormatIntoEmailInputField();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(2500);
        //valid checkout billing address input data getter
        checkoutPage.validCheckoutBillAddressInputDataGetter();
        ...
        //input valid phone into phone input field
        checkoutPage.inputValidCheckoutPhoneIntoPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid email format
        captureScreenshot(driver, "Checkout Page Billing Address Section Display After Invalid Address Data Input (guest) - Invalid Email Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Neplatný formát e-mailová adresa", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page billing address section invalid email input format error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Email Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Email Format");
    }

    //invalid product checkout confirmation test method - existing email (used beforehand in manual testing)
    protected void invalidProductCheckoutConfirmationGuestExistingEmailTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //capture screenshot of the checkout page billing section display before address data input
        captureScreenshot(driver, "Checkout Page Billing Address Section Display Before Address Data Input (guest)");
        //invalid checkout billing address email input data getter - existing email (used beforehand in manual testing)
        checkoutPageInvalidSingularInput.invalidCheckoutBillAddressExistingEmaiInputDataGetter();
        //=input existing email into email input field (used beforehand in manual testing)
        checkoutPageInvalidSingularInput.inputExistingCheckoutEmailIntoEmailInputField();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(2500);
        //valid checkout billing address input data getter
        checkoutPage.validCheckoutBillAddressInputDataGetter();
        ...
        //input valid phone into phone input field
        checkoutPage.inputValidCheckoutPhoneIntoPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - existing email
        captureScreenshot(driver, "Checkout Page Billing Address Section Display After Invalid Address Data Input (guest) - Existing Email");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("E-mail je již používán", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page billing address section existing email input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Existing Email - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Existing Email");
    }

    //invalid product checkout confirmation test method - invalid billing first name format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidFirstNameFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(2500);
        //invalid checkout billing address input data getter - invalid billing first name format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutBillAddressInputDataInvalidFirstNameFormatGetter();
        //input invalid first name format into first name input field (special symbols only)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutFirstNameFormatIntoFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutLastNameIntoLastNameInputField();
        //input valid street into street input field
        checkoutPageInvalidSingularInput.inputValidCheckoutStreetIntoStreetInputField();
        //input valid city into city input field
        ...
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid billing first name format
        captureScreenshot(driver, "Checkout Page Billing Address Section Display After Invalid Address Data Input (guest) - Invalid First Name Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page billing address section invalid first name input format error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing First Name Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing First Name Format");
    }

    //invalid product checkout confirmation test method - invalid billing last name format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidLastNameFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(2500);
        //invalid checkout billing address input data getter - invalid billing last name format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutBillAddressInputDataInvalidLastNameFormatGetter();
        //input valid first name into first name input field
        ...
        checkoutPageInvalidSingularInput.inputInvalidCheckoutLastNameFormatIntoLastNameInputField();
        //input valid street into street input field
        checkoutPageInvalidSingularInput.inputValidCheckoutStreetIntoStreetInputField();
        //input valid city into city input field
        checkoutPageInvalidSingularInput.inputValidCheckoutCityIntoCityInputField();
        ...
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutPhoneIntoPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid billing last name format
        captureScreenshot(driver, "Checkout Page Billing Address Section Display After Invalid Address Data Input (guest) - Invalid Last Name Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page billing address section invalid last name input format error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing Last Name Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
    ...
    //invalid product checkout confirmation test method - invalid billing city format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidCityFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(2500);
        //invalid checkout billing address input data getter - invalid billing city format(special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutBillAddressInputDataInvalidCityFormatGetter();
        //input valid first name into first name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutFirstNameIntoFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutLastNameIntoLastNameInputField();
        ...
        checkoutPageInvalidSingularInput.inputInvalidCheckoutCityFormatIntoCityInputField();
        //click country code dropdown menu
        checkoutPage.clickCountryDropdownMenu();
        //select "United States" option
        checkoutPage.selectSetCountryOption(3);
        ...
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutPhoneIntoPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid billing city format
        captureScreenshot(driver, "Checkout Page Billing Address Section Display After Invalid Address Data Input (guest) - Invalid City Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page billing address section invalid city input format error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing City Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing City Format");
    }

    //invalid product checkout confirmation test method - invalid billing zip code format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidZipCodeFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(2500);
        //invalid checkout billing address input data getter - invalid billing zip code format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutBillAddressInputDataInvalidZipCodeFormatGetter();
        //input valid first name into first name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutFirstNameIntoFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutLastNameIntoLastNameInputField();
        ...
        //select "United States" option
        checkoutPage.selectSetCountryOption(3);
        //input invalid zip code format into zip code input field (special symbols only)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutZipCodeFormatIntoZipCodeInputField();
        //click country code dropdown menu
        checkoutPage.clickCountryCodeDropdownMenu();
        //capture screenshot of the checkout page billing section absence of country codes
        captureScreenshot(driver, "Checkout Page Billing Address Section Display Country Code Options Absence");
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutPhoneIntoPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid billing zip code format
        captureScreenshot(driver, "Checkout Page Billing Address Section Display After Invalid Address Data Input (guest) - Invalid Zip Code Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page billing address section invalid zip code input format error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing Zip Code Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing Zip Code Format");
    }

    //invalid product checkout confirmation test method - invalid billing phone format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidPhoneFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(2500);
        //invalid checkout billing address input data getter - invalid billing phone format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutBillAddressInputDataInvalidPhoneFormatGetter();
        //input valid first name into first name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutFirstNameIntoFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutLastNameIntoLastNameInputField();
        ...
        //capture screenshot of the checkout page billing section absence of country codes
        captureScreenshot(driver, "Checkout Page Billing Address Section Display Country Code Options Absence");
        //input invalid phone format into phone input field (30 digits)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutPhoneFormatIntoPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid billing phone format
        captureScreenshot(driver, "Checkout Page Billing Address Section Display After Invalid Address Data Input (guest) - Invalid Phone Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole musí být platné telefonní číslo.", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page billing address section invalid phone input format error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing Phone Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Billing Phone Format");
    }

    //invalid product checkout confirmation test method - invalid shipping first name format (100 chars)
    protected void invalidProductCheckoutConfirmationGuestInvalidShipFirstNameFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - invalid shipping first name format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutShipAddressInputDataInvalidFirstNameFormatGetter();
        //input invalid first name format into first name input field (special symbols only)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutShipFirstNameFormatIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        //input valid street into street input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipStreetIntoShipStreetInputField();
        //input valid city into city input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipCityIntoShipCityInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryDropdownMenu();
        //select "United States" option
        checkoutPage.selectSetShipCountryOption(3);
        //input valid zip code into zip code input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipZipCodeIntoShipZipCodeInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryCodeDropdownMenu();
        //capture screenshot of the checkout page billing section absence of country codes
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display Country Code Options Absence");
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid shipping first name format
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Invalid Shipping First Name Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping first name input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping First Name Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping First Name Format");
    }

    //invalid product checkout confirmation test method - invalid shipping last name format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidShipLastNameFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - invalid shipping last name format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutShipAddressInputDataInvalidLastNameFormatGetter();
        //input valid first name into first name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input invalid last name format into last name input field (100 chars)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutShipLastNameFormatIntoShipLastNameInputField();
        //input valid street into street input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipStreetIntoShipStreetInputField();
        //input valid city into city input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipCityIntoShipCityInputField();
        ...
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid shipping last name format
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Invalid Shipping Last Name Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping last name input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping Last Name Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping Last Name Format");
    }

    //invalid product checkout confirmation test method - invalid shipping street format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidShipStreetFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - invalid shipping street format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutShipAddressInputDataInvalidStreetFormatGetter();
        //input valid first name into first name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        //input too short street into street input field (100 chars)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutShipStreetFormatIntoShipStreetInputField();
        //input valid city into city input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipCityIntoShipCityInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryDropdownMenu();
        ...
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid shipping street format
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Invalid Shipping Street Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping street input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping Street Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping Street Format");
    }

    //invalid product checkout confirmation test method - invalid shipping city format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidShipCityFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - invalid shipping city format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutShipAddressInputDataInvalidCityFormatGetter();
        //input valid first name into first name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        ...
        checkoutPageInvalidSingularInput.inputValidCheckoutShipStreetIntoShipStreetInputField();
        //input invalid city format into city input field (special symbols only)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutShipCityFormatIntoShipCityInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryDropdownMenu();
        //select "United States" option
        checkoutPage.selectSetShipCountryOption(3);
        ...
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid shipping city format
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Invalid Shipping City Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping city input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping City Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping City Format");
    }

    //invalid product checkout confirmation test method - invalid shipping zip code format (special symbols only)
    protected void invalidProductCheckoutConfirmationGuestInvalidShipZipCodeFormatTest(){
        GeneralPage generalPage = new GeneralPage(driver);
        CheckoutPage checkoutPage = new CheckoutPage(driver);
        CheckoutPageInvalidSingularInput checkoutPageInvalidSingularInput = new CheckoutPageInvalidSingularInput(driver);
        //wait for elements to load
        ...
        //checkout page shipping address section text element assert
        isCheckoutPageShippingAddressSectionTextElementAsExpected(checkoutPage);
        //invalid checkout shipping address input data getter - invalid shipping zip code format (special symbols only)
        checkoutPageInvalidSingularInput.invalidCheckoutShipAddressInputDataInvalidZipCodeFormatGetter();
        //input valid first name into first name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipFirstNameIntoShipFirstNameInputField();
        //input valid last name into last name input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipLastNameIntoShipLastNameInputField();
        ...
        checkoutPage.selectSetShipCountryOption(3);
        //input invalid zip code format into zip code input field (special symbols only)
        checkoutPageInvalidSingularInput.inputInvalidCheckoutShipZipCodeFormatIntoShipZipCodeInputField();
        //click country code dropdown menu
        checkoutPage.clickShipCountryCodeDropdownMenu();
        //capture screenshot of the checkout page billing section absence of country codes
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display Country Code Options Absence");
        //input valid phone into phone input field
        checkoutPageInvalidSingularInput.inputValidCheckoutShipPhoneIntoShipPhoneInputField();
        //capture screenshot of the checkout page billing section display after invalid address data input - invalid shipping zip code format
        captureScreenshot(driver, "Checkout Page Shipping Address Section Display After Invalid Address Data Input (guest) - Invalid Shipping Zip Code Format");
        //click "Submit order" (checkout) button
        checkoutPage.clickSubmitOrderButton();
        //wait for elements to load (due to network issues, wait time is extended)
        generalPage.waitForElementsToLoad(3000);
        //assert the user gets an expected error message, throw an error otherwise (it throws invalid phone number input error, it doesn't seem to accept any phone number)
        try {
            assertEquals("Pole nemůže obsahovat pouze speciální symboly", checkoutPage.getMissingBillingAddressSingularInputErrorMsg(), "The checkout page shipping address section too long shipping zip code input error message doesn't match expectations.");
        } catch (Exception e) {
            captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping Zip Code Format - Missing country code options on checkout");
            throw new Error("The billing country code dropdown menu has no visible country code options.");
        }
        //capture screenshot of the test result
        captureScreenshot(driver, "Invalid Product Checkout Confirmation Test Result (guest) - Invalid Shipping Zip Code Format");
    }
