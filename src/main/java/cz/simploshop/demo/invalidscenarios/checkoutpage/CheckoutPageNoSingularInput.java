...
public class CheckoutPageNoSingularInput extends BasePage{
    ...
    private String noCheckoutShipAddressLastName;
    ...
    //invalid shipping address data (guest) input data getter - no last name
    public void invalidCheckoutShipAddressInputDataNoLastNameGetter(){

        validCheckoutShipAddressFirstName = TestDataGenerator.getRandomFirstName();
        noCheckoutShipAddressLastName = "";
        validCheckoutShipAddressStreet = TestDataGenerator.generateRandomAddress(8);
        validCheckoutShipAddressCity = TestDataGenerator.getRandomCity();
        validCheckoutShipAddressZipCode = TestDataGenerator.getRandomPostalCode();
        validCheckoutShipAddressPhone = TestDataGenerator.generatePhoneNumber(8);

        System.out.println("Invalid checkout shipping address input data (no shipping last name): " + "\n");

        logger.info("Valid checkout shipping address first name (no shipping last name): " + validCheckoutShipAddressFirstName);
        logger.info("No checkout shipping address last name: " + noCheckoutShipAddressLastName);
        logger.info("Valid checkout shipping address street (no shipping last name): " + validCheckoutShipAddressStreet);
        logger.info("Valid checkout shipping address city (no shipping last name): " + validCheckoutShipAddressCity);
        logger.info("Valid checkout shipping address zip code (no shipping last name): " + validCheckoutShipAddressZipCode);
        logger.info("Valid checkout shipping address phone (no shipping last name): " + validCheckoutShipAddressPhone);

        System.out.println("\n");

    }

    //invalid shipping address data (guest) input data getter - no street
    public void invalidCheckoutShipAddressInputDataNoStreetGetter(){

        validCheckoutShipAddressFirstName = TestDataGenerator.getRandomFirstName();
        validCheckoutShipAddressLastName = TestDataGenerator.getRandomLastName();
        noCheckoutShipAddressStreet = "";
        validCheckoutShipAddressCity = TestDataGenerator.getRandomCity();
        validCheckoutShipAddressZipCode = TestDataGenerator.getRandomPostalCode();
        validCheckoutShipAddressPhone = TestDataGenerator.generatePhoneNumber(8);

        System.out.println("Invalid checkout shipping address input data (no shipping street): " + "\n");

        logger.info("Valid checkout shipping address first name (no shipping street): " + validCheckoutShipAddressFirstName);
        logger.info("Valid checkout shipping address last name (no shipping street): " + validCheckoutShipAddressLastName);
        logger.info("No checkout shipping address street: " + noCheckoutShipAddressStreet);
        logger.info("Valid checkout shipping address city (no shipping street): " + validCheckoutShipAddressCity);
        logger.info("Valid checkout shipping address zip code (no shipping street): " + validCheckoutShipAddressZipCode);
        logger.info("Valid checkout shipping address phone (no shipping street): " + validCheckoutShipAddressPhone);

        System.out.println("\n");

    }

    //invalid shipping address data (guest) input data getter - no city
    public void invalidCheckoutShipAddressInputDataNoCityGetter(){

        validCheckoutShipAddressFirstName = TestDataGenerator.getRandomFirstName();
        validCheckoutShipAddressLastName = TestDataGenerator.getRandomLastName();
        validCheckoutShipAddressStreet = TestDataGenerator.generateRandomAddress(8);
        noCheckoutShipAddressCity = "";
        validCheckoutShipAddressZipCode = TestDataGenerator.getRandomPostalCode();
        validCheckoutShipAddressPhone = TestDataGenerator.generatePhoneNumber(8);

        System.out.println("Invalid checkout shipping address input data (no shipping city): " + "\n");

        logger.info("Valid checkout shipping address first name (no shipping city): " + validCheckoutShipAddressFirstName);
        logger.info("Valid checkout shipping address last name (no shipping city): " + validCheckoutShipAddressLastName);
        logger.info("Valid checkout shipping address street (no shipping city): " + validCheckoutShipAddressStreet);
        logger.info("No checkout shipping address city: " + noCheckoutShipAddressCity);
        logger.info("Valid checkout shipping address zip code (no shipping city): " + validCheckoutShipAddressZipCode);
        logger.info("Valid checkout shipping address phone (no shipping city): " + validCheckoutShipAddressPhone);

        System.out.println("\n");

    }

    //invalid shipping address data (guest) input data getter - no zip code
    public void invalidCheckoutShipAddressInputDataNoZipCodeGetter(){

        validCheckoutShipAddressFirstName = TestDataGenerator.getRandomFirstName();
        validCheckoutShipAddressLastName = TestDataGenerator.getRandomLastName();
        validCheckoutShipAddressStreet = TestDataGenerator.generateRandomAddress(8);
        validCheckoutShipAddressCity = TestDataGenerator.getRandomCity();
        noCheckoutShipAddressZipCode = "";
        validCheckoutShipAddressPhone = TestDataGenerator.generatePhoneNumber(8);

        System.out.println("Invalid checkout billing address input data (no shipping zip code): " + "\n");

        logger.info("Valid checkout shipping address first name (no shipping zip code): " + validCheckoutShipAddressFirstName);
        logger.info("Valid checkout shipping address last name (no shipping zip code): " + validCheckoutShipAddressLastName);
        logger.info("Valid checkout shipping address street (no shipping zip code): " + validCheckoutShipAddressStreet);
        logger.info("Valid checkout shipping address city (no shipping zip code): " + validCheckoutShipAddressCity);
        logger.info("No checkout shipping address zip code: " + noCheckoutShipAddressZipCode);
        logger.info("Valid checkout shipping address phone (no billing zip code): " + validCheckoutShipAddressPhone);
